...
export function RegisterPage() {
  ...
  const [role, setRole] = useState<'student' | 'teacher'>(roleFromUrl || 'student');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (role === 'student' && !nis) {
      setError('NIS harus diisi untuk siswa');
      return;
    }

    const success = register(name, email, password, classRoom, nis, role);
    if (success) {
      ...
      setError('Email atau NIS sudah terdaftar');
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="flex items-center gap-6">
              ...
              <Link to="/login" className="text-[#628ECB] hover:text-[#395886] transition-colors font-medium">
                Login
              </Link>
            </nav>
          </div>
      ...
      <main className="max-w-md mx-auto px-4 py-16">
        <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#D5DEEF]">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#395886] mb-2">Daftar Akun</h1>
            <p className="text-[#395886]/70">Buat akun baru untuk memulai pembelajaran</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="role" className="block text-[#395886] mb-2 font-medium">
                Daftar Sebagai
              </label>
            ...
            <div>
              <label htmlFor="name" className="block text-[#395886] mb-2 font-medium">
                Nama Lengkap
              </label>
              <input
                id="name"
            ...
            {role === 'student' && (
              <div>
                <label htmlFor="class" className="block text-[#395886] mb-2 font-medium">
                  Kelas
                </label>
                <input
                  id="class"
            ...
            {role === 'student' && (
              <div>
                <label htmlFor="nis" className="block text-[#395886] mb-2 font-medium">
                  NIS
                </label>
                <input
                  id="nis"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[#395886] mb-2 font-medium">
                Konfirmasi Password
              </label>
              <input
                id="confirmPassword"
          ...
          <div className="mt-6 text-center">
            <p className="text-[#395886]/70">
              Sudah punya akun?{' '}
              <Link to="/login" className="text-[#628ECB] hover:text-[#395886] font-medium">
                Login di sini
              </Link>
            </p>
          </div>
